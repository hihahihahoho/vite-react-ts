...
This project is a replacement for Creat React App with React, TypeScript, Vite, React Router DOM, Zustand, React query, Tailwind CSS (With plugin tailwindcss-themer, twin.macro), emotion and styled emotion, lodash, immer. This README provides an overview of the project setup, scripts, and deployment process.
